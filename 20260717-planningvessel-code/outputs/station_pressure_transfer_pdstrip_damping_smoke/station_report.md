...
- Status: `diagnostic_pressure_transfer_added_pdstrip_style_damping_forward_speed_assembly_not_validated`
- Radiation model: `pressure_transfer_pdstrip_damping_forward`
