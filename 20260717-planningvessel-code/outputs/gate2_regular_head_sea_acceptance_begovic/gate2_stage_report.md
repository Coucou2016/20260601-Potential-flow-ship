...
| --- | --- | --- | --- | --- | --- |
| Begovic EFD kA<=0.055 | heave_motion | 21 | 0.3427938 | 1.1118799 | FAIL |
| Begovic EFD kA<=0.055 | pitch_motion | 21 | 0.35988565 | 1.1088922 | FAIL |

| configuration | metric | peak_is_resolved | computed_peak_is_interior | peak_frequency_relative_error | status | reason |
| --- | --- | --- | --- | --- | --- | --- |
| FnB=1.67 | heave | True | True | 0.1432962 | FAIL | experimental peak is bracketed and uncertainty-resolved |
| FnB=1.67 | pitch | False | True | 0.52858978 | UNRESOLVED | experimental maximum is at the measured-range boundary |
| FnB=2.26 | heave | False | True | 0.22657098 | UNRESOLVED | experimental peak prominence does not exceed digitization uncertainty |
| FnB=2.26 | pitch | True | True | 0.13611907 | FAIL | experimental peak is bracketed and uncertainty-resolved |
| FnB=2.82 | heave | True | True | 0.29105742 | FAIL | experimental peak is bracketed and uncertainty-resolved |
| FnB=2.82 | pitch | True | True | 0.30254128 | FAIL | experimental peak is bracketed and uncertainty-resolved |

- 可用于硬验收的主峰：`4` 个，覆盖 `3` 个航速和 `2` 类运动。
- 已解析主峰最大频率相对误差：`30.254%`，限值为 `10%`。
...
| check | evidence |
| --- | --- |
| finite_outputs | All numeric coverage outputs must be finite. |
...
| begovic_peak_frequency_accuracy | max resolved-peak error=0.30254, limit=0.10; every hard resolved peak must pass. |
