...
- Status: `experimental_pdstrip_like_forward_speed_assembly_not_validated`
- Radiation model: `strip_2p5d_forward`
...
- `forward_speed_assembly_diagnostics.csv` for `strip_2p5d_forward` runs
