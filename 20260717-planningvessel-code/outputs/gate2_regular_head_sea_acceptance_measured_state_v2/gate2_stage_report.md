...
| --- | --- | --- | --- | --- | --- |
| Begovic EFD kA<=0.055 | heave_motion | 21 | 0.58497996 | 2.2029355 | FAIL |
| Begovic EFD kA<=0.055 | pitch_motion | 21 | 0.62306785 | 2.1348345 | FAIL |

| configuration | metric | peak_is_resolved | computed_peak_is_interior | peak_frequency_relative_error | status | reason |
| --- | --- | --- | --- | --- | --- | --- |
| FnB=1.67 | heave | True | True | 0.043949076 | PASS | experimental peak is bracketed and uncertainty-resolved |
| FnB=1.67 | pitch | False | True | 0.40543834 | UNRESOLVED | experimental maximum is at the measured-range boundary |
| FnB=2.26 | heave | False | True | 0.11291353 | UNRESOLVED | experimental peak prominence does not exceed digitization uncertainty |
| FnB=2.26 | pitch | True | True | 0.033993054 | PASS | experimental peak is bracketed and uncertainty-resolved |
| FnB=2.82 | heave | True | True | 0.12691017 | FAIL | experimental peak is bracketed and uncertainty-resolved |
| FnB=2.82 | pitch | True | True | 0.13551537 | FAIL | experimental peak is bracketed and uncertainty-resolved |

- 可用于硬验收的主峰：`4` 个，覆盖 `3` 个航速和 `2` 类运动。
- 已解析主峰最大频率相对误差：`13.552%`，限值为 `10%`。
...
| begovic_peak_frequency_accuracy | max resolved-peak error=0.13552, limit=0.10; every hard resolved peak must pass. |
