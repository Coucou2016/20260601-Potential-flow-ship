...
// Implementation of the Generalized Modes class

#include "Modes.h"
#include "OW3DConstants.h"

OW3DSeakeeping::GMode::GMode(const Grid::GridData &gridData) : Modes(gridData)
{
...
const OW3DSeakeeping::Modes::Motion &OW3DSeakeeping::GMode::GetMotionData(int step, int stage)
{
...
void OW3DSeakeeping::GMode::StoreMotionData() const
{
