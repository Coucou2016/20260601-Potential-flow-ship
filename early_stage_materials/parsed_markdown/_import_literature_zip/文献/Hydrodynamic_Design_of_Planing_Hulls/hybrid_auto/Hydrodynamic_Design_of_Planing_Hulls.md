...
$$
\begin{array}{l} f = \text {distance between} T \text {and CG} \\ \text {(measured normal to} T), \text {ft} \end{array}
$$
...
| 20 | ~0.05 | ~0.10 | ~0.15 | ~0.18 | ~0.20 | ~0.22 | ~0.25 |
</details>
...
Cross-sectional view of a mechanical component with a tapered body and internal grid lines (no text or symbols visible)
</details>
...
$$
\begin{array}{l l} \Delta = 6 0, 0 0 0 \mathrm{LB} & a = 1. 3 9 \mathrm{FT} \\ \mathrm{LCG} = 2 9. 0 \mathrm{FT} & f = 0. 5 0 \mathrm{FT} \\ \mathrm{VCG} = 2. 0 \mathrm{FT} & \varepsilon = 4 ^ {\circ} \end{array}
$$

$$
\begin{array}{r l} b & = 1 4 \text {FT (AVERAGE)} \\ \beta & = 1 0 ^ {\circ} \quad \text {(AVERAGE)} \\ V & = 4 0 \text {KNOTS (67.5 FT / SEC)} \end{array}
$$

REQUIRED:

$$
\begin{array}{l} \text {POWER REQUIREMENT} \\ \text {PORPOISING LIMIT} \end{array}
$$

$$
\frac {\text { POWER   REQUIREMENT }}{V = 4 0 \text { KNOTS }}
$$
...
<table><tr><td>Row</td><td>Quantity</td><td>Source</td><td>Value</td></tr><tr><td>1</td><td> $C_{L0}$ </td><td>Figure 11</td><td>.085</td></tr><tr><td>2</td><td> $\ell_{p}/b$ </td><td>LCG/b</td><td>2.07</td></tr><tr><td>3</td><td> $\lambda$ </td><td>Figure 19</td><td>3.45</td></tr><tr><td>4</td><td> $C_{L0}/\tau^{1.1}$ </td><td>Figure 19</td><td>.035</td></tr><tr><td>5</td><td> $\tau^{1.1}$ </td><td>(1)/(4)</td><td>2.42</td></tr><tr><td>6</td><td> $\tau$ </td><td></td><td>2.23°</td></tr><tr><td>7</td><td> $\text{tant}$ </td><td></td><td>.039</td></tr><tr><td>8</td><td> $\Delta \text{tant}$ </td><td></td><td>2,340</td></tr><tr><td>9</td><td> $\lambda b^{2}$ </td><td>(3) $b^{2}$ </td><td>675</td></tr><tr><td>10</td><td> $V_{m}'$ </td><td>Figure 14</td><td>66.9</td></tr><tr><td>11</td><td> $R_{e}$ </td><td> $V_{m}\lambda b/v$ </td><td>3.22 × 108</td></tr><tr><td>12</td><td> $C_{f}$ </td><td>Schoenherr</td><td>.00177</td></tr><tr><td>13</td><td> $\Delta C_{f}$ </td><td>ATTC Standard Roughness</td><td>.0004</td></tr><tr><td>14</td><td> $C_{f} + \Delta C_{f}$ </td><td>(12) + (13)</td><td>.00217</td></tr><tr><td>15</td><td> $D_{f}$ </td><td> $\frac{\rho V_{m}^{2}\lambda b^{2}(C_{f} + \Delta C_{f})}{2\cos\beta}$ </td><td>6670</td></tr><tr><td>16</td><td> $D_{f}/\cos\tau$ </td><td></td><td>6670</td></tr><tr><td>17</td><td>D</td><td>(8) + (17)</td><td>9010</td></tr><tr><td>18</td><td>EHP</td><td>D × V/550</td><td>1100</td></tr><tr><td>19</td><td> $\sqrt{CL_{\beta}/\beta}$ </td><td></td><td>.186</td></tr><tr><td>20</td><td> $\tau$  porpoising</td><td>Figure 18</td><td> $\leqslant 4.5^{\circ}$ </td></tr></table>
...
| 2 | ~0.68 | ~0.58 | ~0.50 | ~0.44 | ~0.40 |
| 3 | ~0.71 | ~0.64 | ~0.56 | ~0.50 | ~0.45 |
| 4 | ~0.72 | ~0.67 | ~0.60 | ~0.54 | ~0.49 |
| 5 | ~0.73 | ~0.69 | ~0.63 | ~0.57 | ~0.52 |
| 6 | ~0.73 | ~0.70 | ~0.65 | ~0.59 | ~0.54 |
| 7 | ~0.73 | ~0.71 | ~0.67 | ~0.61 | ~0.56 |
| 8 | ~0.73 | ~0.71 | ~0.68 | ~0.62 | ~0.57 |
| 9 | ~0.73 | ~0.71 | ~0.69 | ~0.63 | ~0.58 |
</details>
...
8 Pierson, John D.; Dingce, David A.; and Nei-  
...
9 Korvin-Kroukovsky, B. V.; Savitsky, Daniel; and Lehman, William F. “Wave Contours in the Wake of a 20° Deadrise Planing Surface.” Stevens Institute of Technology, Experimental Towing Tank Report No. 337, June 1948. Sherman M. Fairchild Publication Fund Paper No. 168, Institute of the Aeronautical Sciences, New York.  
