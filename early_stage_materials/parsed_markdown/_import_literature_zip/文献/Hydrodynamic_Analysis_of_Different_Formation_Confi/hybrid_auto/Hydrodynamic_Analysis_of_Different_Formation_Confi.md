...
![](images/5a2a681cd743facebfc35f4f096a6723cdde7623a675a847fe5d55fbfc04c104.jpg)
...
$$
\frac {\partial (\rho k)}{\partial t} + \frac {\partial (\rho k U _ {j})}{\partial t} = \frac {\partial \left[ \left(\mu + \frac {\mu_ {t}}{\sigma_ {k}}\right) \partial k / \partial x _ {j} \right]}{\partial x _ {j}} + G _ {k} + G _ {b} - \rho \varepsilon - Y _ {M} \tag {6}
$$
...
$$
\frac {\partial (\rho \varepsilon)}{\partial t} + \frac {\partial (\rho \varepsilon U _ {j})}{\partial x _ {j}} = \frac {\partial \left[ \left(\mu + \frac {\mu_ {i}}{\sigma_ {s}}\right) \partial \varepsilon / \partial x _ {i} \right]}{\partial x _ {j}} + \rho C _ {1} \bar {S} \varepsilon - \frac {C _ {2} \rho \varepsilon^ {2}}{k + \sqrt {v \varepsilon}} + \frac {C _ {\varepsilon 1} C _ {\varepsilon 3} C _ {b} \varepsilon}{k} \tag {7}
$$
...
![](images/3768d2a4cf44be7f2ac2aa843707de1b7cd2648beacee33866079fa0b8028e68.jpg)

<details>
<summary>natural_image</summary>

3D diagram of two parallel rectangular prisms with labeled dimension Lpp, no text or symbols present
</details>

(a)

![](images/f874f2164a1a3fd06c34e45532b40793e52ef1f32f6fbe61f5803aca9356b951.jpg)

<details>
<summary>natural_image</summary>

3D diagram of two parallel rectangular prisms with labeled dimensions (b, x, y) and origin point (B), no text or symbols beyond labels
</details>
...
![](images/ea09b9712763aafe83ed56ab69f47d1db01ad9625a7629f59752cb83d0806b58.jpg)
...
![](images/e39dc7e7609febfd2c918f652049250cdf7a6d9221d794910a0daf3a597f69c5.jpg)

<details>
<summary>natural_image</summary>

3D wireframe model of a rectangular object inside a transparent enclosure, with no visible text or symbols
</details>
...
3D rendering of a rectangular container with a narrow neck and a side fin, rendered in grayscale (no text or symbols visible)
</details>
...
3D wireframe model of two elongated objects with coordinate axes (X, Y, Z) shown in the corner (no text or symbols on the objects themselves)
</details>
...
$$
p = \frac {1}{l n \left(r _ {2 1}\right)} \left| l n \right| \frac {\varepsilon_ {3 2}}{\varepsilon_ {2 1}} | + q (p) | \tag {9}
$$
...
$$
s = 1 \cdot s g n \left(\frac {\varepsilon_ {3 2}}{\varepsilon_ {2 1}}\right) \tag {11}
$$

where $\varepsilon _ { 2 1 } = \phi _ { 2 } - \phi _ { 1 } , \varepsilon _ { 3 2 } = \phi _ { 3 } - \phi _ { 2 }$ , and $\phi _ { i }$ are the simulation results for different numbers of grids. When $s = 1$ , it indicates that the results showed consistent convergence, and $s = - 1$ $\phi _ { e x t } ^ { 2 1 }$ are defined as:
...
![](images/39025aba3d6826cf1fd2423a64fe9731582416f94ec7bb0161d1ff219d8ec291.jpg)

<details>
<summary>line</summary>

| \(\lambda/L\) | Broglia(2011) | This paper |
| --- | --- | --- |
| 1.0 | ~0.25 | ~0.25 |
| 1.5 | ~2.05 | ~1.95 |
| 1.75 | ~2.6 | ~2.45 |
...
lysis of Drag Reduction in DiffereThe pitch RAO is expressed as [31]:
...
![](images/964a47645190d3ece89d1321e3496d70b85d036a67a54393e660ca439a2c8c3c.jpg)
...
![](images/d3f866e7eac0a049c2f20bac83dd0d627c68f1de5c2096123e4c7b6d52eebda3.jpg)
...
![](images/d4e7f7a40f7abe96616ca5b64a896a8e033548d852b63fc22109316100536d4a.jpg)

<details>
<summary>natural_image</summary>

Abstract illustration of three stylized swords emitting light waves against a blue gradient background (no text or symbols)
</details>

![](images/d7ca040684d57688c839c16e92612a0b225c996ae71c5ba3e853d0a16db3d9fd.jpg)

<details>
<summary>natural_image</summary>

Abstract fluid dynamics visualization with three parallel arrows indicating direction of flow or pressure (no text or symbols)
</details>
...
Abstract fluid dynamics visualization with streamlines and gradient colors (no text or symbols)
</details>
...
Abstract wave pattern with blue and yellow gradients, no text or symbols present
</details>
...
Abstract fluid dynamics visualization with three parallel blue and beige pipes flowing through a blue gradient background (no text or symbols)
</details>

![](images/dd519ce69706df16e7c98dd5bb93c9f9abe1e9c218961096b4595f2efd989f07.jpg)
...
![](images/4d72a7073455daff53ae09b976b0a7eb8d9ce93eee78c11b148452fbd738d13c.jpg)

<details>
<summary>line</summary>

| ST/Lpp | Single Ship (10^-2) | Ship 1 (10^-2) | Ship 2 (10^-2) |
| --- | --- | --- | --- |
| 0.25 | ~0.77 | ~0.78 | ~1.11 |
| 0.5 | ~0.77 | ~0.77 | ~1.01 |
| 0.75 | ~0.77 | ~0.77 | ~0.71 |
...
| ST/Lpp | Single ship (Heave Amplitude \((10^{-2}\) m)) | Ship 1 (Heave Amplitude \((10^{-2}\) m)) | Ship 2 (Heave Amplitude \((10^{-2}\) m)) |
| --- | --- | --- | --- |
| 0.25 | ~6.78 | ~6.78 | ~6.60 |
| 0.5 | ~6.78 | ~6.78 | ~6.15 |
| 0.75 | ~6.78 | ~6.78 | ~5.65 |
...
| ST/Lpp | Single ship (deg) | Ship 1 (deg) | Ship 2 (deg) |
| --- | --- | --- | --- |
| 0.25 | ~4.78 | ~4.78 | ~4.26 |
| 0.5 | ~4.77 | ~4.77 | ~3.88 |
| 0.75 | ~4.77 | ~4.77 | ~4.00 |
...
| ST/Lpp | Single ship (10^-2) | Ship 1 (10^-2) | Ship 2 (10^-2) | Ship 3 (10^-2) |
| --- | --- | --- | --- | --- |
| 0.25 | ~0.77 | ~0.78 | ~1.10 | ~1.10 |
| 0.5 | ~0.77 | ~0.77 | ~1.03 | ~1.08 |
| 0.75 | ~0.77 | ~0.77 | ~0.71 | ~0.54 |
| 1 | ~0.76 | ~0.76 | ~0.50 | ~0.41 |
| 1.25 | ~0.76 | ~0.76 | ~0.51 | ~0.43 |
| 1.5 | ~0.76 | ~0.76 | ~0.70 | ~0.65 |
| 1.75 | ~0.76 | ~0.76 | ~0.92 | ~0.88 |
| 2 | ~0.77 | ~0.77 | ~0.93 | ~1.02 |
</details>
...
![](images/89befc6e1fad25eb54a10cc4cef6ade8bca1b35e594315e34a0986d70b851544.jpg)
...
| --- | --- | --- | --- | --- |
| 0.25 | ~6.75 | ~6.75 | ~6.6 | ~6.2 |
| 0.5 | ~6.75 | ~6.75 | ~6.15 | ~5.25 |
| 0.75 | ~6.75 | ~6.75 | ~5.6 | ~4.6 |
| 1 | ~6.75 | ~6.75 | ~5.5 | ~4.55 |
| 1.25 | ~6.75 | ~6.75 | ~5.65 | ~4.5 |
| 1.5 | ~6.75 | ~6.75 | ~5.65 | ~4.25 |
| 1.75 | ~6.75 | ~6.75 | ~5.5 | ~4.0 |
| 2 | ~6.75 | ~6.75 | ~5.25 | ~3.85 |
</details>
...
| ST/Lpp | Single Ship (deg) | Ship 1 (deg) | Ship 2 (deg) | Ship 3 (deg) |
| --- | --- | --- | --- | --- |
| 0.25 | ~4.75 | ~4.75 | ~4.25 | ~4.00 |
| 0.5 | ~4.75 | ~4.75 | ~3.85 | ~3.35 |
| 0.75 | ~4.75 | ~4.75 | ~4.00 | ~3.30 |
| 1 | ~4.75 | ~4.75 | ~4.05 | ~3.40 |
| 1.25 | ~4.75 | ~4.75 | ~4.10 | ~3.30 |
| 1.5 | ~4.75 | ~4.75 | ~4.10 | ~3.15 |
| 1.75 | ~4.75 | ~4.75 | ~3.90 | ~3.10 |
| 2 | ~4.75 | ~4.75 | ~3.65 | ~2.90 |
</details>
...
![](images/437ec1dad15c789a6aa803e84d3bdb0a0bc147343752af7094fcf3b103c2ee0b.jpg)

<details>
<summary>heatmap</summary>

| Position[Z] (m) | Intensity |
| --- | --- |
| 0 | Low |
| 0.075 | Medium |
| 0.15 | High |
...
![](images/19e90d413fc5c244885fed1ebc13fbe83daaa6da77c49a77de4580755b3b5ad6.jpg)
...
| ST/LPP | SP/B | Heavy Amplitude (10^-2 m) |
| --- | --- | --- |
| 0.5 | 0 | ~6.3 |
| 0.5 | 1 | ~5.1 |
| 1.5 | 0 | ~5.1 |
...
| ST/LPP | SP/B | Pitch Avatility (dS2) |
| --- | --- | --- |
| 0.5 | 0 | ~3.6 |
| 0.5 | 1 | ~3.6 |
| 1.5 | 0 | ~3.6 |
...
![](images/4f4f2134123e9d025affbe310cececc63122d927c5fcc2a1706d06a8126932a8.jpg)

<details>
<summary>natural_image</summary>

Abstract illustration of two stylized arrows converging toward a blue gradient background (no text or symbols)
</details>

(a)

![](images/231fff105ce1b2454fd0b45575c5add6081311e37b36df95875d603c1f006abd.jpg)
...
![](images/0a00f2a025e303663b48847833388f5222728c1d669c2015c1c17bc3daa6ad6f.jpg)

<details>
<summary>natural_image</summary>

Abstract fluid dynamics visualization with streamlines and arrows, no text or symbols present
</details>

re d(c)

![](images/5c34453243c46e39370cf92fc07982a96319a8da980bc7e405325c7eb3c24b3c.jpg)

<details>
<summary>natural_image</summary>

Abstract wave pattern with blue and yellow gradients and two dark gray arrows indicating direction (no text or symbols)
</details>

, le(d)

![](images/859bff6477d32a85979b597593122c049674146b85ae007b5a1214b0247c906e.jpg)
...
Figure 19. The free surface deformations of lateral formation in different longitudinal and lateralFigure 19. The free surface deformations of lateral formation in different longitudinal and lateral distances: (a) distances: $\mathrm { ( } \mathbf { a } \mathrm { ) } \mathrm { S T } / L _ { P P } = 0 . 5 , \mathrm { S P } / B = 0 . 2 5 ;$ P =  (b) $\mathrm { S T } / L _ { P P } = 1 , \mathrm { S P } / B = 0 . 5 ; \mathrm { } ( \mathbf { c } ) \mathrm { S T } / L _ { P P } = 1 . 2 5 , \mathrm { S P } / B = 0 . 7 5 ;$ (d) $\mathrm { S T } / L _ { P P } = 1 . 5 , \mathrm { S P } / B = 1 .$ .
...
Shahzad, M.W.; Burhan, M.; Ang, L.; Ng, K.C. Energy-water-environment nexus underpinning future desalination sustainability. Desalination 2017, 413, 52–64. [CrossRef]  
Novimar. Novimar and the Vessel Train Concept 2017. Available online: https://novimar.eu/concept/ (accessed on 10 March 2024).  
