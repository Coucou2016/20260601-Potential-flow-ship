...
double OW3DSeakeeping::FSK03Function(
    double k,
    void *params)
{
...
// NOTE : This function is related to the omega0_3 in the following-seas condition:
//
// omega0_3 = g*tanh(kh)/(2*U*cos(beta)) * (1 + sqrt(1 + omegae*4*U*cos(beta)/(g*tanh(kh)) ))
