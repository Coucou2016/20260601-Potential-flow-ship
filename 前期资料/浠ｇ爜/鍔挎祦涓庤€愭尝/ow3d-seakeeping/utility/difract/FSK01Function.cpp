...
double OW3DSeakeeping::FSK01Function(
    double k,
    void *params)
{
...
// NOTE : This function is related to the omega0_1 in the following-seas condition:
//
// omega0_1 = g*tanh(kh)/(2*U*cos(beta)) * (1 - sqrt(1 - omegae*4*U*cos(beta)/(g*tanh(kh)) ))
